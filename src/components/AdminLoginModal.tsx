...
import { useApp, SECURE_ADMIN_PHONE } from '../context/AppContext';
...
export const AdminLoginModal: React.FC<AdminLoginModalProps> = ({ onClose, initialMode = 'login' }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await loginAdmin(password.trim(), SECURE_ADMIN_PHONE);
      if (!res.success) {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        setSuccessMsg(`Password reset instructions have been dispatched for authorized director ${SECURE_ADMIN_PHONE}.`);
      } else {
        ...
        <div className="modal-body">
          ...
          {view === 'login' && (
            <form onSubmit={handleLogin}>
              <div style={{ marginBottom: '14px' }}>
                ...
                >
                  <span>📞</span>
                  <span>97846 64518</span>
                </div>
                <p style={{ margin: '4px 0 0 0', fontSize: '11px', color: '#64748b' }}>
                  Access is strictly restricted to authorized admin mobile number 97846 64518.
                </p>
              </div>
          ...
          {view === 'forgot_password' && (
            <form onSubmit={handleForgotPassword}>
              ...
              >
                ...
                Password reset and credential recovery instructions for authorized director mobile:
                <div
                  style={{
                    marginTop: '8px',
                    fontWeight: 700,
          ...
          {view === 'setup' && (
            <form onSubmit={handleSetup}>
              ...
              >
                <b>Initialize Director Credentials:</b> This will register your secret password in Firebase Authentication for authorized mobile{' '}
                <span style={{ fontWeight: 700, color: '#092b63' }}>97846 64518</span>. No default or hardcoded passwords will be stored.
              </div>
